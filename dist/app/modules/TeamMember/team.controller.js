...
const getTeam = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield team_services_1.TeamMemberService.getTeamMemberbyDB();
